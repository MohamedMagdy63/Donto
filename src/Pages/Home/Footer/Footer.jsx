            ...
            <div className="footer-copy-right text-center text-white">
                <p className='mb-0'>&copy; 2024 - 
                    <span className="developer">
                        <a className="text-white p-1" href="https://magdy.framer.website" target='_blank' rel="noreferrer" >Mohamed Magdy</a>
                    </span> 
                    | All Rights Reserved 
                     <a  className="text-center text-white p-1 " href="https://webx-crafters.vercel.app" target='_blank' rel="noreferrer" >WebX-Crafters</a>
                </p>
            </div>
        </div>
    );
